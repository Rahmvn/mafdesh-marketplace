      ...
      <div className="min-h-screen bg-blue-50 py-10 px-4">
        <div className="max-w-6xl mx-auto bg-white rounded-xl shadow-lg p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <div className="mt-6 space-y-3">
                ...
                <button className="w-full border border-blue-300 text-blue-700 py-3 rounded-lg font-semibold">
                  Buy Now
                </button>
              </div>
          ...
          <div className="flex gap-4 mt-10">
            <button
              onClick={onClose}
              className="flex-1 border border-blue-300 text-blue-700 py-3 rounded-lg font-semibold"
            >
              Edit Product
            </button>
